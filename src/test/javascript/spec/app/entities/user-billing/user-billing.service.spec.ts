...
describe('Service Tests', () => {
    ...
    describe('UserBilling Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(UserBillingService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-billings';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserBilling', () => {

                let entity: UserBilling;
                service.find(123).subscribe((_entity: UserBilling) => {
                    entity = _entity;
                });
