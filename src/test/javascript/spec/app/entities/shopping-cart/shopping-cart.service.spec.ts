    ...
    describe('ShoppingCart Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/shopping-carts';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ShoppingCart', () => {

                let entity: ShoppingCart;
                service.find(123).subscribe((_entity: ShoppingCart) => {
                    entity = _entity;
                });
