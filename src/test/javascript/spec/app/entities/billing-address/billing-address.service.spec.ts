...
describe('Service Tests', () => {
    ...
    describe('BillingAddress Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BillingAddressService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/billing-addresses';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BillingAddress', () => {

                let entity: BillingAddress;
                service.find(123).subscribe((_entity: BillingAddress) => {
                    entity = _entity;
                });
